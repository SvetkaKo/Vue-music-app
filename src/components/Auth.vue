...
// mapGetter is better for perfoming a calculation on/with a state property
// mapState is better for retrieving a state property
...
export default {
  ...
  computed: {
    ...
    // or I can write a function to return var from store/index.js
    // authModalShow() {
